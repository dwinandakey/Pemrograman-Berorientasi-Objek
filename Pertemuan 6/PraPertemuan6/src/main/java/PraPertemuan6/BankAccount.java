...
class Person {
  ...
  /**
   * mengembalikan akunBank dari objek person berdasarkan parameter
   * noRekening.
   *
  ...
  /**
   * Menampilkan daftar akun bank berupa no rekening dan nama bank dan saldo
   * dari objek person. ====== Daftar Rekening Bank [NAMA Objek Person]
   * ======== 1. [BRI] [12312313] [Rp. xxxxx] 2. [BCA] [********] [Rp. xxxxx]
   * 3. ...
   */
  public void tampilListRekeningBank() {
    System.out.println(
      "====== Daftar Rekening Bank " + this.nama + " ========"
    );
    // TO DO
    //============================================================================
  ...
  /**
   * menghitung dan mengembalikan semua total saldo dari semua akunbank yg
   * dimiliki objek person
   *
   * @return rekapSaldo
   */
  public double rekapSaldoRekening() {
    ...
    //==============================================================================
    System.out.println(
      "Total Saldo Semua Rekening " + this.nama + " : Rp." + rekapSaldo
    );
    return rekapSaldo;
  }
}
...
class Bank {
  ...
  /**
   * mengenerate dan mengembalikan nomor rekening bank . panjang no.rekening
   * HARUS 9 digit : (kode bank 3 digit + 6 digit).
   *
  ...
  public String generateNoRek() {
    ...
    // TAMBAHKAN KODE DISINI !!!
    //=========================================================
    return (this.kodeBank + String.valueOf(new Random().nextInt(212576))); // ubah returnnya
  }
...
public class BankAccount implements ITransaksi {
  ...
  public void tarikSaldo(double jumlahUang) {
    ...
    if (saldo >= jumlahUang) {
      saldo -= jumlahUang;
      System.out.println("Penarikan berhasil sebesar Rp." + jumlahUang);
    } else {
      System.out.println(
        "Saldo tidak mencukupi untuk penarikan sebesar Rp." + jumlahUang
      );
    }
    //=============================
  }
  ...
  public void setor(double jumlahUang) {
    ...
    //===========================================
    System.out.println(
      "Berhasil setor ke rekening sejumlah : Rp." + jumlahUang
    );
  }

  /**
   * Method transfer, saldo akunbank pengirim akan berkurang dan saldo
   * akunbank penerima akan bertambah sesuai jumlah uang yang ditransfer pada
   * parameter.
   *
   * @param jumlahUang
   * @param penerima
  ...
  public void transfer(double jumlahUang, Person penerima, String noRek) {
    ...
    if (saldo >= jumlahUang) {
      ...
      System.out.println(
        "Saldo tidak mencukupi untuk transfer sebesar Rp." + jumlahUang
      );
    }
  }
